...
var LOCALE_HE = {
  ...
  "about.termsData": "נתוני הלוח נשמרים בדפדפן. כשהסנכרון פעיל, עותק מוצפן נשלח לשרת התיווך שהוגדר ועשוי להישמר בו. כל מי שמחזיק בקישור צוות יכול לגשת ללוח ולשנותו. קישורי הזמנה וקודי QR לרטרוספקטיבה מאפשרים גישה באותו האופן; קישורי משתתפים עשויים לשתף גם את לוח הצוות. שתפו אותם רק עם שותפים מיועדים, ורק בערוץ מאובטח.",
  "about.termsPrivacy": "הימנעו מהזנת מידע אישי רגיש. הצפנה אינה הופכת קישורים משותפים לפרטיים: כל מי שמחזיק בקישור או סורק את קוד ה-QR יכול לראות את הנתונים שהוא מעניק גישה אליהם. ספקי אחסון עשויים לקבל נתוני חיבור. פנו למפעיל ההתקנה שלכם לגבי שמירה ומחיקה; ניקוי אחסון הדפדפן אינו מוחק עותקים בשרת.",
