...
var LOCALE_HE = {
  ...
  "importJson.title": "ייבוא JSON — צוותים ודירוגים",
  "importJson.hint": "הייבוא קורא רק את הצוותים שבקובץ, ומתאים כל אחד מהם לצוות בלוח הזה לפי שם — שם שלא נמצא כאן ייווצר כחדש. מה שקורה לצוות קיים, או לדירוג שכבר יש לו, תלוי במצב שלמטה.",
  "importJson.modeLabel": "כל דבר בלוח הזה שלא נמצא בקובץ — צוות, או אחד מהדירוגים שלו",
  ...
  "importJson.replaceWarningTitle": "מצב החלפה מסיר כל דבר שלא נמצא בקובץ הזה.",
  ...
  "importJson.scopeConfig": "הגדרות הלוח",
  "importJson.scopeNote": "גם בקובץ הזה, אך לא מיובא כאן: {list}.",
