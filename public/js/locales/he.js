...
var LOCALE_HE = {
  ...
  "about.termsData": "נתוני הלוח נשמרים בדפדפן. כשהסנכרון פעיל, עותק מוצפן נשלח לשרת התיווך שהוגדר ועשוי להישמר בו. כל מי שמחזיק בקישור צוות יכול לגשת ללוח ולשנותו. קודי מפגש והזמנות מאפשרים גישה לרטרוספקטיבה; קישורי משתתפים עשויים לשתף גם את לוח הצוות. שתפו אותם רק עם שותפים מיועדים.",
  "about.termsPrivacy": "הימנעו מהזנת מידע אישי רגיש. הצפנה אינה הופכת קישורים משותפים לפרטיים: מפתחות ההצפנה של הרטרוספקטיבה נגזרים מקוד המפגש, ולכן מפעיל שרת התיווך יכול לגזור אותם. ספקי אחסון עשויים לקבל נתוני חיבור. פנו למפעיל ההתקנה שלכם לגבי שמירה ומחיקה; ניקוי אחסון הדפדפן אינו מוחק עותקים בשרת.",
