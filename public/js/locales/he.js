...
var LOCALE_HE = {
  ...
  "about.creditTuckman": "שלבי התפתחות צוות: המודל התיאורטי מבוסס על ברוס ו׳ טאקמן (1965), עם מרי אן ס׳ ג׳נסן (1977). שאלון 20 ההיגדים באפליקציה עצמו נכתב על ידי Dr. Agile בעזרת Claude, בהתאם מכוון לאותו סולם תלת-ערכי ולאותה שיטת ניקוד מצטבר כמו העיבוד ל-Five Dysfunctions ביישום זה — ואינו העתק של כלי חיצוני כלשהו.",
  ...
  "about.participantText": "פתחו את קישור ההזמנה מהמנחה, או סרקו את קוד ה-QR שלו. ענו על ההיגדים או בחרו צבע, ואז שלחו. השתתפו בדיון; ייתכן שהתוצאות יוצגו רק כשהמנחה יחשוף אותן.",
  ...
  "about.start": "בתצוגת צוות, בחרו צוות והתחילו רטרוספקטיבה. שתפו קישור למשתתפים או קוד QR.",
  ...
  "join.pacing.counter": "שאלה {current} מתוך {total}",
  ...
  "retro.startOptions.pacingLabel": "שאלה אחת בכל פעם",
  "retro.startOptions.pacingHint": "במקום כל הסקר בבת אחת, כל חבר צוות רואה שאלה אחת ואתם קובעים מתי כולם עוברים לשאלה הבאה.",
  "retro.startOptions.dimensionsSummary": "בחרו אילו ממדים לכלול",
  "retro.startOptions.dimensionsHint": "בטלו סימון של ממד שלא רלוונטי לרטרו הזה — הוא ידולג רק במפגש הנוכחי, התבנית השמורה לא משתנה.",
  "retro.startOptions.noDimensionsHint": "בחרו לפחות ממד אחד כדי להתחיל.",
  ...
  "retro.pacing.finishButton": "סיום השאלות",
  "retro.pacing.doneHint": "כל השאלות הוצגו.",
  ...
  "retro.shareLink.summary": "סריקה או שיתוף קישור",
  "retro.shareLink.hint": "בחלק מהטלפונים, סריקה זו פותחת את אפליקציית Claude ללוח הרגיל במקום לרטרו — אם זה קורה, העתיקו את הקישור למטה ושתפו אותו במקום.",
  "retro.shareLink.linkLabel": "קישור הצטרפות",
  "retro.shareLink.copy": "העתקה",
  "retro.shareSecurity.notice": "הערה: כל מי שיש לו את הקישור הזה — או שסורק את קוד ה-QR הזה — יכול לראות את הנתונים במפגש Squad Pulse הזה. שתפו אותו רק בערוץ מאובטח, וודאו שקוד ה-QR עצמו גלוי רק לאנשים שאמורים לקבל גישה.",
  ...
  "retro.coFacilitate.codeNotOpen": "קישור המפגש הזה אינו פתוח.",
