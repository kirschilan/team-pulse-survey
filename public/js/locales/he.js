...
var LOCALE_HE = {
  ...
  "about.creditTuckman": "שלבי התפתחות צוות: המודל התיאורטי מבוסס על ברוס ו׳ טאקמן (1965), עם מרי אן ס׳ ג׳נסן (1977). שאלון 20 ההיגדים באפליקציה עצמו נכתב על ידי Claude לבקשת בעל המוצר, בהתאם מכוון לאותו סולם תלת-ערכי ולאותה שיטת ניקוד מצטבר כמו העיבוד ל-Five Dysfunctions ביישום זה — ואינו העתק של כלי חיצוני כלשהו.",
